...
@Component({
  selector: 'app-e-echart-line',
  templateUrl: 'e-echart-line.page.html',
  styleUrls: ['e-echart-line.page.scss']
})
export class EchartLinePage implements OnInit {

  curIndex: string = '';
  colorList = ['#157EFF', '#157EFF', '#157EFF', '#157EFF', '#157EFF', '#157EFF', '#157EFF', '#157EFF']
  ...
  initPieChart() {
    this.myChart1 = echarts.init(document.getElementById('echart_change'));
